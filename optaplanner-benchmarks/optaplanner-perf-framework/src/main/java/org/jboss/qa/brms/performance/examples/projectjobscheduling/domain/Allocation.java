...
import org.jboss.qa.brms.performance.examples.projectjobscheduling.domain.solver.DelayStrengthComparator;
import org.jboss.qa.brms.performance.examples.projectjobscheduling.domain.solver.ExecutionModeStrengthWeightFactory;
import org.jboss.qa.brms.performance.examples.projectjobscheduling.domain.solver.NotSourceOrSinkAllocationFilter;
import org.jboss.qa.brms.performance.examples.projectjobscheduling.domain.solver.PredecessorsDoneDateUpdatingVariableListener;
...
public class Allocation extends AbstractPersistable {
    ...
    @CustomShadowVariable(variableListenerClass = PredecessorsDoneDateUpdatingVariableListener.class,
            sources = {
                @CustomShadowVariable.Source(variableName = "executionMode"),
