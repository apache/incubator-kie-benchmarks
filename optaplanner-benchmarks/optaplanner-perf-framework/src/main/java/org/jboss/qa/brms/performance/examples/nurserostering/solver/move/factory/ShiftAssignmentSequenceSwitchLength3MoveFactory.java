...
package org.jboss.qa.brms.performance.examples.nurserostering.solver.move.factory;
...
import org.jboss.qa.brms.performance.examples.nurserostering.solver.drools.EmployeeWorkSequence;
import org.jboss.qa.brms.performance.examples.nurserostering.solver.move.EmployeeChangeMove;

public class ShiftAssignmentSequenceSwitchLength3MoveFactory implements MoveListFactory<NurseRoster> {
