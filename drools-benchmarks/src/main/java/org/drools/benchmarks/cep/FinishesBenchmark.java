...
/**
 * Benchmarks "finishes" CEP operator.
 */
public class FinishesBenchmark extends AbstractCEPBenchmark {
    ...
    public void setup() throws ProviderException {
        ...
        events.addAll(eventProvider.getEvents(EventB.class, eventsNumber / 2, 5, 100, 7));
        createKieSession(ClockTypeOption.get("pseudo"));
    }

    @Benchmark
    public int testFinishesOperator() {
