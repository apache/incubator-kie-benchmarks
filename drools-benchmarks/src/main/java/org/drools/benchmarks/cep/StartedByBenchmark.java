...
/**
 * Benchmarks "startedby" CEP operator.
 */
public class StartedByBenchmark extends AbstractCEPBenchmark {
    ...
    public void setupKieBase() {
        final DRLProvider drlProvider =
                new CepRulesProvider(EventA.class, EventB.class, TemporalOperator.STARTED_BY, "", "");
    ...
    public void setup() throws ProviderException {
        ...
        events.addAll(eventProvider.getEvents(EventA.class, rulesAndEventsNumber / 2, 2, 100, 7));
    ...
    @Benchmark
    public int testStartedByOperator() {
