...
/**
 * Benchmarks "during" CEP operator.
 */
public class DuringBenchmark extends AbstractCEPBenchmark {
    ...
    public void setupKieBase() {
        final DrlProvider drlProvider =
                new CepRulesProvider(EventA.class, EventB.class, TemporalOperator.DURING, "", "");
    ...
    public void setup() throws ProviderException {
        ...
        events.addAll(eventProvider.getEvents(EventB.class, rulesAndEventsNumber / 2, 5, 100, 5));
        createKieSession(ClockTypeOption.get("pseudo"));
    }

    @Benchmark
    public int testDuringOperator() {
