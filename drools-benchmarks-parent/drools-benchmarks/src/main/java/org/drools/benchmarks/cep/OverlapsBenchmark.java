 ...
 */
public class OverlapsBenchmark extends AbstractCEPBenchmark {
    ...
    public void setupKieBase() {
        final DRLProvider drlProvider =
                new CepRulesProvider(EventA.class, EventB.class, TemporalOperator.OVERLAPS, "1", "10");
    ...
    public void setup() throws ProviderException {
        ...
        events.addAll(eventProvider.getEvents(EventA.class, rulesAndEventsNumber / 2, 5, 100, 10));
