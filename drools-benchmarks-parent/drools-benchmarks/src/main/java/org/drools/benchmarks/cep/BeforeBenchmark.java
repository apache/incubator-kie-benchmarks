...
public class BeforeBenchmark extends AbstractCEPBenchmark {
    ...
    public void setup() throws ProviderException {
        ...
        events.addAll(eventProvider.getEvents(EventB.class, rulesAndEventsNumber / 2, 2, 100, 0));
        events.addAll(eventProvider.getEvents(EventA.class, rulesAndEventsNumber / 2, 5, 100, 0));
