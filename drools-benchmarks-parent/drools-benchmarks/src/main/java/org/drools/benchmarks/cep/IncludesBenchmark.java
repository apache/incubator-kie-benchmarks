...
/**
 * Benchmarks "includes" CEP operator.
 */
public class IncludesBenchmark extends AbstractCEPBenchmark {
    ...
    public void setupKieBase() {
        final DRLProvider drlProvider =
                new CepRulesProvider(EventA.class, EventB.class, TemporalOperator.INCLUDES, "", "");
    ...
    public void setup() throws ProviderException {
        ...
        events.addAll(eventProvider.getEvents(EventA.class, rulesAndEventsNumber / 2, 5, 100, 5));
    ...
    @Benchmark
    public int testIncludesOperator() {
