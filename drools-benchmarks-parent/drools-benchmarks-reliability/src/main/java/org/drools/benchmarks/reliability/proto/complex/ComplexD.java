...
public class ComplexD extends AbstractBean implements StringListContainer {
     ...
     * @param value
     */
    public ComplexD(final int value) {
        super(value);
    }

    public ComplexD(final long id, final int value) {
        super(id, value);
    }

    public ComplexD(final long id, final int value, final List<String> list1, final List<String> list2, final List<String> list3, final List<String> list4, final List<String> list5, final List<String> list6, final List<String> list7, final List<String> list8, final List<String> list9, final List<String> list10) {
        super(id, value);
        this.list1 = list1;
        this.list2 = list2;
        this.list3 = list3;
